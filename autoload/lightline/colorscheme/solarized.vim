...
let s:p.normal.left = [ [ s:base3, s:base1, 'bold' ], [ s:base3, s:base00 ] ]
let s:p.normal.right = [ [ s:base3, s:base1 ], [ s:base3, s:base00 ] ]
let s:p.inactive.right = [ [ s:base03, s:base00 ], [ s:base0, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base02 ], [ s:base0, s:base02 ] ]
let s:p.insert.left = [ [ s:base3, s:green, 'bold' ], [ s:base3, s:base00 ] ]
let s:p.replace.left = [ [ s:base3, s:red, 'bold' ], [ s:base3, s:base00 ] ]
let s:p.visual.left = [ [ s:base3, s:magenta, 'bold' ], [ s:base3, s:base00 ] ]
let s:p.normal.middle = [ [ s:base1, s:base02 ] ]
let s:p.inactive.middle = [ [ s:base01, s:base02 ] ]
let s:p.tabline.left = [ [ s:base3, s:base00 ] ]
let s:p.tabline.tabsel = [ [ s:base3, s:base1, 'bold' ] ]
